...
window.addEventListener('DOMContentLoaded', function () {
  ...
  introductionbtn.addEventListener('click', readMore); // initFormValidation();
  // Modules
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    Object(_modules_footer__WEBPACK_IMPORTED_MODULE_2__["initFooter"])();
...
function trapFocus(element) {
  var focusableEls = element.querySelectorAll('input[type="text"], input[type="tel"], textarea,  input[type="checkbox"], button');
